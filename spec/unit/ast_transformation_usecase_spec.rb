...
describe BEL::LibBEL::BelAstNode do
  ...
  describe "#transform" do
    ...
    xit "supports parameter replacement" do
      ...
      original_ast_string = BEL::LibBEL::bel_ast_as_string(bel_ast)
      ...
      transformed_ast_string = BEL::LibBEL::bel_ast_as_string(transformed_ast)
